...
# Shift Imon-1[A] values by 0.2e-12
df_filtered['Imon-1[A]'] = df_filtered['Imon-1[A]'] - 0.2e-12
...
for name, group in grouped:
    ...
    results.append([Y_pos, Z_pos, X_pos, max_value, half_max_value, half_max_emon, emon_minus_0_05, imon_minus_0_05, emon_plus_0_05, imon_plus_0_05])

# Convert the results list to a DataFrame
results_df = pd.DataFrame(results, columns=['Y-pos[m]', 'Z-pos[m]', 'X-pos[m]', 'I_lim[A]', '1/2I_lim[A]', 'E(1/2I_lim)[V]', 'E(1/2I_lim)-0.05[V]', 'I(E-0.05)[A]', 'E(1/2I_lim)+0.05[V]', 'I(E+0.05)[A]'])
